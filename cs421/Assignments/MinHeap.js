...
class MinHeap {
  ...
  replaceElem(pos, elem) {
      ...
      this._upHeap(i);
      this._downHeap(i);
      return oldElem; //Error Added 11/4/20
  }
}

class Item  {// eslint-disable-line no-unused-vars
...
class PriorityQueue {// eslint-disable-line no-unused-vars
  constructor(compare) {
  ...
  minElement() {
    return this._heap.minElem().element();
  }
  size() {
